...
namespace PE18
{
    class Program
    {
        static string[] gegeven = System.IO.File.ReadAllLines(@"C:\Users\Ben\Documents\Ben\Programmeren\C#\ProjectEuler\PE67\triangle.txt");
        ...
        static void Main(string[] args)
        {
            pyramideVullen();
            transformeren();
            Console.WriteLine(pyramide[0][0]);
        }
